...
export default function ProfileScreen() {
  ...
  // Destaques
  const highlights = [
    { id: '1', title: 'Massas', image: require('../../assets/images/default-avatar.png') },
    { id: '2', title: 'Doces', image: require('../../assets/images/default-avatar.png') },
    { id: '3', title: 'Asiática', image: require('../../assets/images/default-avatar.png') },
    { id: '4', title: 'BBQ', image: require('../../assets/images/default-avatar.png') },
    { id: '5', title: 'Fitness', image: require('../../assets/images/default-avatar.png') },
  ];
        ...
        <View className="bg-white px-4 pt-4">
          <View className="flex-row items-center">
            ...
            <View className="flex-1 ml-4">
              <Text className="text-xl font-bold mb-1">{userData.username}</Text>
              ...
              <View className="flex-row justify-between mt-2">
                ...
                <View className="items-center">
                  <Text className="font-bold text-base">{userData.followers}</Text>
                  <Text className="text-sm text-gray-500">followers</Text>
                </View>
                <View className="items-center">
                  <Text className="font-bold text-base">{userData.following}</Text>
          ...
          <TouchableOpacity 
            className="bg-gray-200 rounded-md py-2 mt-3 mb-4"
