      ...
      <ScrollView className="flex-1">
        ...
        <View className="p-4">
          ...
          <View className="flex-row items-center mt-4 mb-3">
            ...
            />
            <View>
              <Text className="font-medium text-gray-900">@{post.user?.username || 'usuário'}</Text>
              <Text className="text-xs text-gray-500">{formatTimestamp(post.timestamp)}</Text>
            </View>
          </View>
          
          <Text className="text-gray-700 text-base mb-6">
            {post.description || `Uma deliciosa refeição! ${post.title ? ` Este(a) ${post.title} ficou incrível.` : ''}`}
          </Text>
          ...
          <View className="flex-row justify-between items-center py-3 border-t border-gray-200">
            ...
            <TouchableOpacity className="flex-row items-center">
              ...
              <Text className="text-gray-600 ml-2">{post.comments || 0} comentários</Text>
            </TouchableOpacity>
        ...
        <View className="p-4 pt-0">
          ...
          {post.comments && post.comments > 0 ? (
            <View>
              ...
              <View className="flex-row">
                ...
                <View className="bg-gray-100 p-2 rounded-lg flex-1">
                  ...
                  <Text>Onde você comprou os ingredientes? Ficou com uma aparência incrível!</Text>
            ...
            <View className="bg-gray-100 p-4 rounded-lg items-center">
              <Text className="text-gray-500">Ainda não há comentários neste post</Text>
              <Text className="text-gray-500 text-xs mt-1">Seja o primeiro a comentar!</Text>
            </View>
          )}
